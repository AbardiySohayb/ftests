...
{
    /// <inheritdoc />
    public partial class sohayb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Etd", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EtdId = table.Column<int>(type: "int", nullable: true),
                    ProfId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EtdProf", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EtdProf_EtdId",
                table: "EtdProf",
                column: "EtdId");

            migrationBuilder.CreateIndex(
                name: "IX_EtdProf_ProfId",
                table: "EtdProf",
                column: "ProfId");
        }
